...
def createpayLoadWithEmptyPid(context,buid):
    body = {
        "meta": {
       "bm_request_id": "01c00add-2f6b-4ff5-a6b3-0f5240e7e9b9",
       "bm_session_id": "01c00add-2f6b-4ff5-a6b3-0f5240e7e9b9",
...
def createpayLoadWithEmptyAuthSignal(context,buid):
    response_json = context.response.json()
    context.pid = response_json['data']['application']['pid']
    response_json = context.response.json()
    context.pid = response_json['data']['application']['pid']
...
def createpayLoadWithEmptyBuid(context,buid):
    response_json = context.response.json()
    context.pid = response_json['data']['application']['pid']
    response_json = context.response.json()
    context.pid = response_json['data']['application']['pid']
...
def createpayLoadWithEmptyMeta(context,buid):
    response_json = context.response.json()
    context.pid = response_json['data']['application']['pid']
    response_json = context.response.json()
    context.pid = response_json['data']['application']['pid']
